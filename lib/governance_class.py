...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to timed "gobject list" output
    ...
    def timed_serialise(self):
        import timelib
        return timelib.SHIM_serialise_for_timed(self.serialise())
